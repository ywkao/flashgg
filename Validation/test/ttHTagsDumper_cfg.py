...
process.tthLeptonicLooseTagDumper = createTagDumper("TTHLeptonicLooseTag")
process.tthLeptonicTagDumper = createTagDumper("TTHLeptonicTag")
process.tthHadronicLooseTagDumper = createTagDumper("TTHHadronicLooseTag")
process.tthHadronicTagDumper = createTagDumper("TTHHadronicTag")

process.tthLeptonicLooseTagDumper.dumpTrees = True
process.tthLeptonicTagDumper.dumpTrees = True
process.tthHadronicLooseTagDumper.dumpTrees = True
...
tth_leptonic_variables = ["n_ele    := electrons.size",
...
tth_hadronic_variables = ["n_bjets  := nBMedium",
...
## TTH leptonic ##
cfgTools.addCategories(process.tthLeptonicLooseTagDumper,
                       ## categories definition
                       [("all","1",0)
                    ],
                       ## variables to be dumped in trees/datasets. Same variables for all categories
                       variables=dipho_variables+tth_leptonic_variables,
                       ## histograms
                       histograms=[]
)
...
## TTH hadronic loose ##
cfgTools.addCategories(process.tthHadronicLooseTagDumper,
                       ## categories definition
                       [("all","1",0)
                    ],
                       ## variables to be dumped in trees/datasets. Same variables for all categories
                       variables=dipho_variables+tth_hadronic_variables,
                       ## histograms
                       histograms=[]
)
...
process.p1 = cms.Path(process.tthLeptonicLooseTagDumper
		      +process.tthLeptonicTagDumper
		      +process.tthHadronicLooseTagDumper
