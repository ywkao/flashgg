...
flashggFCNCHadronicTag = cms.EDProducer("FlashggFCNCHadronicTagProducer",
                                       ...
                                       METTag=cms.InputTag('flashggMets'),
                                       rhoTag = cms.InputTag('fixedGridRhoFastjetAll'),
                                       fcncHutBDTNRBAWeightFile = cms.FileInPath("flashgg/Taggers/data/Hadronic_addTopTaggers_nonres_v5.1_12Jun2020_hut_bdt.xml"),
                                       fcncHutBDTSMHAWeightFile = cms.FileInPath("flashgg/Taggers/data/Hadronic_addTopTaggers_smhiggs_v5.1_12Jun2020_hut_bdt.xml"),
                                       fcncHctBDTNRBAWeightFile = cms.FileInPath("flashgg/Taggers/data/Hadronic_addTopTaggers_nonres_v5.1_12Jun2020_hct_bdt.xml"),
                                       fcncHctBDTSMHAWeightFile = cms.FileInPath("flashgg/Taggers/data/Hadronic_addTopTaggers_smhiggs_v5.1_12Jun2020_hct_bdt.xml"),
                                       fcncHutMVAWeightFile = cms.FileInPath("flashgg/Taggers/data/Hadronic_addTopTaggers_nonres_v5.1_12Jun2020_hut_bdt.xml"),
                                       fcncHctMVAWeightFile = cms.FileInPath("flashgg/Taggers/data/Hadronic_addTopTaggers_nonres_v5.1_12Jun2020_hut_bdt.xml"),
                                       tthMVAweightfile = cms.FileInPath("flashgg/Taggers/data/TMVAClassification_tth_hadronic_2017Data_30vars_v0.weights.xml"),
                                       topTaggerXMLfile = cms.FileInPath("flashgg/Taggers/data/resTop_xgb_csv_order_deepCTag.xml"),
                                       fcncTaggerXMLfile_tt = cms.FileInPath("flashgg/Taggers/data/fcncTagger/TThad_ANN_v2.weights.xml"),
                                       fcncTaggerXMLfile_st = cms.FileInPath("flashgg/Taggers/data/fcncTagger/SThad_ANN_v2.weights.xml"),
                                       tthVsDiphoDNNfile = cms.FileInPath("flashgg/Taggers/data/ttHHadronic_ttH_vs_dipho_v1.6_28May2019_weights.pb"),
                                       tthVsttGGDNNfile = cms.FileInPath("flashgg/Taggers/data/ttHHadronic_ttH_vs_ttGG_v1.6_28May2019_weights.pb"),
                                       tthMVA_RunII_weightfile = cms.FileInPath("flashgg/Taggers/data/ttHHadronic_RunII_MVA_28May2019.xml"),
                                       MVAMethod = cms.string("BDT"),
                                       ...
                                       BoundariesHutNRB = cms.vdouble(0.922917, 0.947899, 0.978783, 0.9882),
                                       BoundariesHctNRB = cms.vdouble(0.868698, 0.968178, 0.984509, 0.9913),
                                       BoundariesHutSMH = cms.vdouble(0.541095, 0.609071, 0.812856, 0.909529),
                                       BoundariesHctSMH = cms.vdouble(0.632789, 0.774256, 0.819160, 0.895076),
                                       dRJetPhoLeadCut =  cms.double(0.4),
                                       dRJetPhoSubleadCut = cms.double(0.4),
                                       MuonEtaCut = cms.double(2.4),
                                       MuonPtCut = cms.double(5),
...
flashggFCNCLeptonicTag = cms.EDProducer("FlashggFCNCLeptonicTagProducer",
                                       ...
                                       GenParticleTag=cms.InputTag( "flashggPrunedGenParticles" ),
                                       rhoTag = cms.InputTag('fixedGridRhoFastjetAll'),
                                       fcncHutMVAWeightFile = cms.FileInPath("flashgg/Taggers/data/Leptonic_addTopTaggers_smhiggs_v5.1_12Jun2020_hut_bdt.xml"),
                                       fcncHctMVAWeightFile = cms.FileInPath("flashgg/Taggers/data/Leptonic_addTopTaggers_smhiggs_v5.1_12Jun2020_hut_bdt.xml"), 
                                       fcncHutBDTNRBAWeightFile = cms.FileInPath("flashgg/Taggers/data/Leptonic_addTopTaggers_nonres_v5.1_12Jun2020_hut_bdt.xml"),
                                       fcncHutBDTSMHAWeightFile = cms.FileInPath("flashgg/Taggers/data/Leptonic_addTopTaggers_smhiggs_v5.1_12Jun2020_hut_bdt.xml"),
                                       fcncHctBDTNRBAWeightFile = cms.FileInPath("flashgg/Taggers/data/Leptonic_addTopTaggers_nonres_v5.1_12Jun2020_hct_bdt.xml"),
                                       fcncHctBDTSMHAWeightFile = cms.FileInPath("flashgg/Taggers/data/Leptonic_addTopTaggers_smhiggs_v5.1_12Jun2020_hct_bdt.xml"),
                                       MVAweightfile = cms.FileInPath("flashgg/Taggers/data/TMVAClassification_BDT_training_v2.json.weights.xml"),
                                       topTaggerXMLfile = cms.FileInPath("flashgg/Taggers/data/resTop_xgb_csv_order_deepCTag.xml"),
                                       fcncTaggerXMLfile_tt = cms.FileInPath("flashgg/Taggers/data/fcncTagger/TTlep_ANN_v3.weights.xml"),
                                       fcncTaggerXMLfile_st = cms.FileInPath("flashgg/Taggers/data/fcncTagger/STlep_ANN_v3.weights.xml"),
                                       tthVsttGGDNNfile = cms.FileInPath("flashgg/Taggers/data/ttHLeptonic_ttH_vs_ttGG_v1.6_28May2019_weights.pb"),
                                       tthMVA_RunII_weightfile = cms.FileInPath("flashgg/Taggers/data/ttHLeptonic_RunII_MVA_12Jun2019.xml"),
                                       ...
                                       MVAThresholdHutNRB = cms.vdouble(0.772895, 0.810267, 0.9323),
                                       MVAThresholdHctNRB = cms.vdouble(0.776727, 0.808134, 0.9054),
                                       MVAThresholdHutSMH = cms.vdouble(0.437164, 0.619253, 0.766727),
                                       MVAThresholdHctSMH = cms.vdouble(0.283887, 0.500838, 0.706084),
                                       PhoMVAThreshold = cms.double(-0.7),
                                       jetsNumberThreshold = cms.double(1.),
                                       bjetsNumberThreshold = cms.double(0.),
                                       jetPtThreshold = cms.double(25.),
