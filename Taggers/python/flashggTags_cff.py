...
bDiscriminatorDeepJet = cms.vdouble
...
flashggTTHHadronicTag = cms.EDProducer("FlashggTTHHadronicTagProducer",
                                       ...
                                       UseLargeMVAs = cms.bool(True), # by default, don't use large MVAs that can cause memory crashes
...
#                                       tthMVAweightfile = cms.FileInPath("flashgg/Taggers/data/TMVAClassification_tth_hadronic_2017Data_35vars_v0.weights.xml"),
                                       ...
                                       fcncHutBDTNRBAWeightFile = cms.FileInPath("flashgg/Taggers/data/Hadronic_addTopTaggers_noTopBDT_nonres_v5.10_22Jan2021_hut_bdt.xml"),
                                       fcncHutBDTSMHAWeightFile = cms.FileInPath("flashgg/Taggers/data/Hadronic_addTopTaggers_noTopBDT_smhiggs_v5.10_22Jan2021_hut_bdt.xml"),
                                       fcncHctBDTNRBAWeightFile = cms.FileInPath("flashgg/Taggers/data/Hadronic_addTopTaggers_noTopBDT_nonres_v5.10_22Jan2021_hct_bdt.xml"),
                                       fcncHctBDTSMHAWeightFile = cms.FileInPath("flashgg/Taggers/data/Hadronic_addTopTaggers_noTopBDT_smhiggs_v5.10_22Jan2021_hct_bdt.xml"), 
...
#                                       bTag = cms.string(flashggBTag),
                                       ...
                                       Boundaries = cms.vdouble(-1.0, -1.0, -1.0, -1.0),
                                       #Boundaries = cms.vdouble(0.986025, 0.9948537, 0.9983046, 0.9990729),
                                       Boundaries_pt1 = cms.vdouble(-1.0, -1.0, -1.0, -1.0),
                                       Boundaries_pt2 = cms.vdouble(-1.0, -1.0, -1.0, -1.0),
                                       Boundaries_pt3 = cms.vdouble(-1.0, -1.0, -1.0, -1.0),
                                       Boundaries_pt4 = cms.vdouble(-1.0, -1.0, -1.0, -1.0),
...
flashggTTHLeptonicTag = cms.EDProducer("FlashggTTHLeptonicTagProducer",
                                       ...
                                       fcncHutBDTNRBAWeightFile = cms.FileInPath("flashgg/Taggers/data/Leptonic_addTopTaggers_noTopBDT_nonres_v5.10_22Jan2021_hut_bdt.xml"),
                                       fcncHutBDTSMHAWeightFile = cms.FileInPath("flashgg/Taggers/data/Leptonic_addTopTaggers_noTopBDT_smhiggs_v5.10_22Jan2021_hut_bdt.xml"),
                                       fcncHctBDTNRBAWeightFile = cms.FileInPath("flashgg/Taggers/data/Leptonic_addTopTaggers_noTopBDT_nonres_v5.10_22Jan2021_hct_bdt.xml"),
                                       fcncHctBDTSMHAWeightFile = cms.FileInPath("flashgg/Taggers/data/Leptonic_addTopTaggers_noTopBDT_smhiggs_v5.10_22Jan2021_hct_bdt.xml"),
                                       leadPhoOverMassThreshold = cms.double(0.33),
                                       subleadPhoOverMassThreshold = cms.double(0.25),
                                       #tthVstHThreshold = cms.double(0.13699667), # 97% ttH eff
                                       tthVstHThreshold = cms.double(0.0),

                                       #MVAThreshold = cms.vdouble(0.8435, 0.9346, 0.9625, 0.9890),
                                       #MVAThreshold = cms.vdouble(0.8997816, 0.95635754, 0.9725133, 0.9870608),
                                       MVAThreshold = cms.vdouble(-1.0, -1.0, -1.0, -1.0),
                                       MVAThreshold_pt1 = cms.vdouble(-1.0, -1.0, -1.0, -1.0),
                                       MVAThreshold_pt2 = cms.vdouble(-1.0, -1.0),
                                       MVAThreshold_pt3 = cms.vdouble(-1.0, -1.0),
                                       MVAThreshold_pt4 = cms.vdouble(-1.0, -1.0),
