...
"jet_pt9                :=  ? jets.size()>8 ? jets[8].pt() : -100 ",
			...
			"jet_b_DeepCSV_discriminant1  := ?(jets.size>0)? jets.at(0).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet_b_DeepCSV_discriminant2  := ?(jets.size>1)? jets.at(1).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet_b_DeepCSV_discriminant3  := ?(jets.size>2)? jets.at(2).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet_b_DeepCSV_discriminant4  := ?(jets.size>3)? jets.at(3).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet_b_DeepCSV_discriminant5  := ?(jets.size>4)? jets.at(4).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet_b_DeepCSV_discriminant6  := ?(jets.size>5)? jets.at(5).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet_b_DeepCSV_discriminant7  := ?(jets.size>6)? jets.at(6).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet_b_DeepCSV_discriminant8  := ?(jets.size>7)? jets.at(7).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet_b_DeepCSV_discriminant9  := ?(jets.size>8)? jets.at(8).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet_b_DeepCSV_discriminant10  := ?(jets.size>9)? jets.at(9).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet_b_DeepCSV_discriminant11  := ?(jets.size>10)? jets.at(10).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet_b_DeepCSV_discriminant12  := ?(jets.size>11)? jets.at(11).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet_b_DeepCSV_discriminant13  := ?(jets.size>12)? jets.at(12).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet_b_DeepCSV_discriminant14  := ?(jets.size>13)? jets.at(13).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet_b_DeepCSV_discriminant15  := ?(jets.size>14)? jets.at(14).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
...
cfgTools.addCategories(process.tthHadronicTagDumper,
			...
			"jet1_b_DeepCSV_discriminant  := ?(jetVector.size>0)? jetVector.at(0).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet2_b_DeepCSV_discriminant  := ?(jetVector.size>1)? jetVector.at(1).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet3_b_DeepCSV_discriminant  := ?(jetVector.size>2)? jetVector.at(2).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet4_b_DeepCSV_discriminant  := ?(jetVector.size>3)? jetVector.at(3).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet5_b_DeepCSV_discriminant  := ?(jetVector.size>4)? jetVector.at(4).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet6_b_DeepCSV_discriminant  := ?(jetVector.size>5)? jetVector.at(5).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet7_b_DeepCSV_discriminant  := ?(jetVector.size>6)? jetVector.at(6).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet8_b_DeepCSV_discriminant  := ?(jetVector.size>7)? jetVector.at(7).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet9_b_DeepCSV_discriminant  := ?(jetVector.size>8)? jetVector.at(8).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet10_b_DeepCSV_discriminant  := ?(jetVector.size>9)? jetVector.at(9).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet11_b_DeepCSV_discriminant  := ?(jetVector.size>10)? jetVector.at(10).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet12_b_DeepCSV_discriminant  := ?(jetVector.size>11)? jetVector.at(11).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet13_b_DeepCSV_discriminant  := ?(jetVector.size>12)? jetVector.at(12).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet14_b_DeepCSV_discriminant  := ?(jetVector.size>13)? jetVector.at(13).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
                        "jet15_b_DeepCSV_discriminant  := ?(jetVector.size>14)? jetVector.at(14).bDiscriminator('pfDeepCSVJetTags:probb') : -1",
