...
cfgTools.addCategories(process.tthHadronicTagDumper,
			...
			"topTag_score := topTagScore",
                        "topTag_topMass := topTagTopMass",
                        "topTag_WMass := topTagWMass",
			"topTag_topPt := topTagTopPt",
                        "topTag_WPt := topTagWPt",
			"topTag_topEta := topTagTopEta",
                        "topTag_WEta := topTagWEta",
			"topTag_topPhi := topTagTopPhi",
                        "topTag_WPhi := topTagWPhi",
