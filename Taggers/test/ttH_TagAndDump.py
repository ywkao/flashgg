...
def applyGenTopPtReweight(filenames):
    ...
    elif "TTGG" in filenames[0] or "TTGJets" in filenames[0] or "TTJets" in filenames[0] or "TTTo" in filenames[0]:
...
leptonic_variables = [  "n_ele    := electrons.size",
                        ...
                        "jet_bdiscriminant1     :=  ? jets.size()>0 ? jets[0].bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jets[0].bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jets[0].bDiscriminator('mini_pfDeepFlavourJetTags:problepb') : -100",
                        "jet_pt2                :=  ? jets.size()>1 ? jets[1].pt() : -100 ",
                        "jet_eta2               :=  ? jets.size()>1 ? jets[1].eta() : -100 ",
                        "jet_phi2               :=  ? jets.size()>1 ? jets[1].phi() : -100 ",
                        "jet_bdiscriminant2     :=  ? jets.size()>1 ? jets[1].bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jets[1].bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jets[1].bDiscriminator('mini_pfDeepFlavourJetTags:problepb') : -100",
                        "jet_pt3                :=  ? jets.size()>2 ? jets[2].pt() : -100 ",
                        "jet_eta3               :=  ? jets.size()>2 ? jets[2].eta() : -100 ",
                        "jet_phi3               :=  ? jets.size()>2 ? jets[2].phi() : -100 ",
                        "jet_bdiscriminant3     :=  ? jets.size()>2 ? jets[2].bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jets[2].bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jets[2].bDiscriminator('mini_pfDeepFlavourJetTags:problepb') : -100",
                        "jet_pt4                :=  ? jets.size()>3 ? jets[3].pt() : -100 ",
                        "jet_eta4               :=  ? jets.size()>3 ? jets[3].eta() : -100 ",
                        "jet_phi4               :=  ? jets.size()>3 ? jets[3].phi() : -100 ",
                        "jet_bdiscriminant4     :=  ? jets.size()>3 ? jets[3].bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jets[3].bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jets[3].bDiscriminator('mini_pfDeepFlavourJetTags:problepb') : -100",
                        "jet_pt5                :=  ? jets.size()>4 ? jets[4].pt() : -100 ",
                        "jet_eta5               :=  ? jets.size()>4 ? jets[4].eta() : -100 ",
                        "jet_phi5               :=  ? jets.size()>4 ? jets[4].phi() : -100 ",
                        "jet_bdiscriminant5     :=  ? jets.size()>4 ? jets[4].bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jets[4].bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jets[4].bDiscriminator('mini_pfDeepFlavourJetTags:problepb') : -100",
                        "jet_pt6                :=  ? jets.size()>5 ? jets[5].pt() : -100 ",
                        "jet_eta6               :=  ? jets.size()>5 ? jets[5].eta() : -100 ",
                        "jet_phi6               :=  ? jets.size()>5 ? jets[5].phi() : -100 ",
                        "jet_bdiscriminant6     :=  ? jets.size()>5 ? jets[5].bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jets[5].bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jets[5].bDiscriminator('mini_pfDeepFlavourJetTags:problepb') : -100",
                        "jet_pt7                :=  ? jets.size()>6 ? jets[6].pt() : -100 ",
                        "jet_eta7               :=  ? jets.size()>6 ? jets[6].eta() : -100 ",
                        "jet_phi7               :=  ? jets.size()>6 ? jets[6].phi() : -100 ",
                        "jet_bdiscriminant7     :=  ? jets.size()>6 ? jets[6].bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jets[6].bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jets[6].bDiscriminator('mini_pfDeepFlavourJetTags:problepb') : -100",
                        "jet_pt8                :=  ? jets.size()>7 ? jets[7].pt() : -100 ",
                        "jet_eta8               :=  ? jets.size()>7 ? jets[7].eta() : -100 ",
                        "jet_phi8               :=  ? jets.size()>7 ? jets[7].phi() : -100 ",
                        "jet_bdiscriminant8     :=  ? jets.size()>7 ? jets[7].bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jets[7].bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jets[7].bDiscriminator('mini_pfDeepFlavourJetTags:problepb') : -100",
                        "jet_pt9                :=  ? jets.size()>8 ? jets[8].pt() : -100 ",
                        "jet_eta9               :=  ? jets.size()>8 ? jets[8].eta() : -100 ",
                        "jet_phi9               :=  ? jets.size()>8 ? jets[8].phi() : -100 ",
                        "jet_bdiscriminant9     :=  ? jets.size()>8 ? jets[8].bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jets[8].bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jets[8].bDiscriminator('mini_pfDeepFlavourJetTags:problepb') : -100",
                        "jet_pt10                :=  ? jets.size()>9 ? jets[9].pt() : -100 ",
                        "jet_eta10               :=  ? jets.size()>9 ? jets[9].eta() : -100 ",
                        "jet_phi10               :=  ? jets.size()>9 ? jets[9].phi() : -100 ",
                        "jet_bdiscriminant10     :=  ? jets.size()>9 ? jets[9].bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jets[9].bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jets[9].bDiscriminator('mini_pfDeepFlavourJetTags:problepb') : -100",
                        "jet_pt11                :=  ? jets.size()>10 ? jets[10].pt() : -100 ",
                        "jet_eta11               :=  ? jets.size()>10 ? jets[10].eta() : -100 ",
                        "jet_phi11               :=  ? jets.size()>10 ? jets[10].phi() : -100 ",
                        "jet_bdiscriminant11     :=  ? jets.size()>10 ? jets[10].bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jets[10].bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jets[10].bDiscriminator('mini_pfDeepFlavourJetTags:problepb') : -100",
                        "jet_pt12                :=  ? jets.size()>11 ? jets[11].pt() : -100 ",
                        "jet_eta12               :=  ? jets.size()>11 ? jets[11].eta() : -100 ",
                        "jet_phi12               :=  ? jets.size()>11 ? jets[11].phi() : -100 ",
                        "jet_bdiscriminant12     :=  ? jets.size()>11 ? jets[11].bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jets[11].bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jets[11].bDiscriminator('mini_pfDeepFlavourJetTags:problepb') : -100",
                        "jet_pt13                :=  ? jets.size()>12 ? jets[12].pt() : -100 ",
                        "jet_eta13               :=  ? jets.size()>12 ? jets[12].eta() : -100 ",
                        "jet_phi13               :=  ? jets.size()>12 ? jets[12].phi() : -100 ",
                        "jet_bdiscriminant13     :=  ? jets.size()>12 ? jets[12].bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jets[12].bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jets[12].bDiscriminator('mini_pfDeepFlavourJetTags:problepb') : -100",
                        "jet_pt14                :=  ? jets.size()>13 ? jets[13].pt() : -100 ",
                        "jet_eta14               :=  ? jets.size()>13 ? jets[13].eta() : -100 ",
                        "jet_phi14               :=  ? jets.size()>13 ? jets[13].phi() : -100 ",
                        "jet_bdiscriminant14     :=  ? jets.size()>13 ? jets[13].bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jets[13].bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jets[13].bDiscriminator('mini_pfDeepFlavourJetTags:problepb') : -100",
                        "jet_pt15                :=  ? jets.size()>14 ? jets[14].pt() : -100 ",
                        "jet_eta15               :=  ? jets.size()>14 ? jets[14].eta() : -100 ",
                        "jet_phi15               :=  ? jets.size()>14 ? jets[14].phi() : -100 ",
                        "jet_bdiscriminant15     :=  ? jets.size()>14 ? jets[14].bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jets[14].bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jets[14].bDiscriminator('mini_pfDeepFlavourJetTags:problepb') : -100",
...
hadronic_variables = [  "n_bjets  := nBMedium",
                        ...
                        "jet1_bdiscriminant  := ?(jetVector.size>0)? jetVector.at(0).bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jetVector.at(0).bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jetVector.at(0).bDiscriminator('mini_pfDeepFlavourJetTags:problepb'): -1",
                        "jet2_bdiscriminant  := ?(jetVector.size>1)? jetVector.at(1).bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jetVector.at(1).bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jetVector.at(1).bDiscriminator('mini_pfDeepFlavourJetTags:problepb'): -1",
                        "jet3_bdiscriminant  := ?(jetVector.size>2)? jetVector.at(2).bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jetVector.at(2).bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jetVector.at(2).bDiscriminator('mini_pfDeepFlavourJetTags:problepb'): -1",
                        "jet4_bdiscriminant  := ?(jetVector.size>3)? jetVector.at(3).bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jetVector.at(3).bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jetVector.at(3).bDiscriminator('mini_pfDeepFlavourJetTags:problepb'): -1",
                        "jet5_bdiscriminant  := ?(jetVector.size>4)? jetVector.at(4).bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jetVector.at(4).bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jetVector.at(4).bDiscriminator('mini_pfDeepFlavourJetTags:problepb'): -1",
                        "jet6_bdiscriminant  := ?(jetVector.size>5)? jetVector.at(5).bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jetVector.at(5).bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jetVector.at(5).bDiscriminator('mini_pfDeepFlavourJetTags:problepb'): -1",
                        "jet7_bdiscriminant  := ?(jetVector.size>6)? jetVector.at(6).bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jetVector.at(6).bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jetVector.at(6).bDiscriminator('mini_pfDeepFlavourJetTags:problepb'): -1",
                        "jet8_bdiscriminant  := ?(jetVector.size>7)? jetVector.at(7).bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jetVector.at(7).bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jetVector.at(7).bDiscriminator('mini_pfDeepFlavourJetTags:problepb'): -1",
                        "jet9_bdiscriminant  := ?(jetVector.size>8)? jetVector.at(8).bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jetVector.at(8).bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jetVector.at(8).bDiscriminator('mini_pfDeepFlavourJetTags:problepb'): -1",
                        "jet10_bdiscriminant  := ?(jetVector.size>9)? jetVector.at(9).bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jetVector.at(9).bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jetVector.at(9).bDiscriminator('mini_pfDeepFlavourJetTags:problepb'): -1",
                        "jet11_bdiscriminant  := ?(jetVector.size>10)? jetVector.at(10).bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jetVector.at(10).bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jetVector.at(10).bDiscriminator('mini_pfDeepFlavourJetTags:problepb'): -1",
                        "jet12_bdiscriminant  := ?(jetVector.size>11)? jetVector.at(11).bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jetVector.at(11).bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jetVector.at(11).bDiscriminator('mini_pfDeepFlavourJetTags:problepb'): -1",
                        "jet13_bdiscriminant  := ?(jetVector.size>12)? jetVector.at(12).bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jetVector.at(12).bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jetVector.at(12).bDiscriminator('mini_pfDeepFlavourJetTags:problepb'): -1",
                        "jet14_bdiscriminant  := ?(jetVector.size>13)? jetVector.at(13).bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jetVector.at(13).bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jetVector.at(13).bDiscriminator('mini_pfDeepFlavourJetTags:problepb'): -1",
                        "jet15_bdiscriminant  := ?(jetVector.size>14)? jetVector.at(14).bDiscriminator('mini_pfDeepFlavourJetTags:probb') + jetVector.at(14).bDiscriminator('mini_pfDeepFlavourJetTags:probbb') + jetVector.at(14).bDiscriminator('mini_pfDeepFlavourJetTags:problepb'): -1",
