#ifndef FLASHgg_FCNCHadronicTag_h
#define FLASHgg_FCNCHadronicTag_h
...
namespace flashgg {
    ...
    class FCNCHadronicTag: public DiPhotonTagBase
    {
    public:
        FCNCHadronicTag();
        FCNCHadronicTag( edm::Ptr<DiPhotonCandidate>, edm::Ptr<DiPhotonMVAResult>, std::vector<edm::Ptr<flashgg::Jet> >, std::vector<edm::Ptr<flashgg::Jet> > );
        FCNCHadronicTag( edm::Ptr<DiPhotonCandidate>, DiPhotonMVAResult, std::vector<edm::Ptr<flashgg::Jet> >, std::vector<edm::Ptr<flashgg::Jet> > );
        FCNCHadronicTag *clone() const override { return ( new FCNCHadronicTag( *this ) ); }
        ~FCNCHadronicTag();
        ...
        DiPhotonTagBase::tag_t tagEnum() const override {return DiPhotonTagBase::kFCNCHadronic; }
