#ifndef FLASHgg_FCNCLeptonicTag_h
#define FLASHgg_FCNCLeptonicTag_h
...
namespace flashgg {
    ...
    class FCNCLeptonicTag: public DiPhotonTagBase
    {
    public:
        FCNCLeptonicTag();
        FCNCLeptonicTag( edm::Ptr<DiPhotonCandidate>, edm::Ptr<DiPhotonMVAResult> );
        FCNCLeptonicTag( edm::Ptr<DiPhotonCandidate>, DiPhotonMVAResult );

        ~FCNCLeptonicTag();

        FCNCLeptonicTag *clone() const override { return ( new FCNCLeptonicTag( *this ) ); }
        ...
        DiPhotonTagBase::tag_t tagEnum() const override {return DiPhotonTagBase::kFCNCLeptonic; }
